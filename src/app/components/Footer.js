...
export default function Footer() {
  ...
  return (
    <footer className="relative h-10 shrink-0 border-t border-brand/20 bg-gradient-to-r from-brand-light/30 via-white to-brand-light/20 backdrop-blur-md dark:border-brand/10 dark:from-slate-900 dark:via-slate-900 dark:to-slate-950 sm:h-11">
      <div
        aria-hidden
      ...
      />
      <div className="relative mx-auto flex h-10 max-h-10 items-center gap-2 overflow-hidden px-3 sm:h-11 sm:max-h-11 sm:gap-3 sm:px-6 max-w-6xl">
        ...
        <p className={`${copyrightClassName} flex min-w-0 max-w-[42%] items-center gap-1 truncate text-[8px] leading-none sm:hidden`}>
          <span className="font-semibold text-brand-dark dark:text-brand">© {year}</span>
          <span aria-hidden className="text-brand/35">
            ·
          </span>
          <span className="truncate font-semibold text-slate-800 dark:text-slate-100">Zahid Hasan</span>
        </p>
