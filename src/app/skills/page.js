...
export default function SkillsPage() {
  return (
    <main className="min-h-screen bg-white px-4 sm:px-6 py-8 sm:py-12 pt-20 text-gray-800">
      <section className="max-w-6xl mx-auto">
        <h1 className="text-lg sm:text-xl font-bold text-[#3e0097] mb-6 sm:mb-10">Skills</h1>

        {/* Special Skills Section */}
        <div className="mb-8 sm:mb-12">
          <h2 className="text-xl sm:text-2xl font-semibold text-[#3e0097] mb-3 sm:mb-4">Special Skills</h2>
        ...
        {/* All Skills Table */}
        <div>
          <h2 className="text-xl sm:text-2xl font-semibold text-[#3e0097] mb-3 sm:mb-4">All Skills</h2>
          <div className="overflow-x-auto -mx-4 sm:mx-0 px-4 sm:px-0">
            <table className="min-w-[520px] sm:min-w-full w-full border border-gray-300 text-left text-sm sm:text-base">
              ...
              <tbody>
                {[
                  ...
                  <tr key={i} className="border-t">
                    <td className="py-2 px-3 sm:px-4 border font-medium whitespace-nowrap align-top">{category}</td>
                    <td className="py-2 px-3 sm:px-4 border align-top">{tools}</td>
                  </tr>
                ))}
              </tbody>
            </table>
